...
index = 11
while index < 13
  Dir.foreach("./public/2017-2018/boxscore/#{index}") do |file|
    next if file == "." or file == ".."
    game_data = File.read("./public/2017-2018/boxscore/#{index}/" + file)
...
index = 11
while index < 13
  Dir.foreach("./public/2017-2018/games/#{index}") do |file|
    next if file == "." or file == ".."
      game_info = File.read("./public/2017-2018/games/#{index}/" + file)
...
while index < 13
  Dir.foreach("./public/2017-2018/boxscore/#{index}") do |file|
    next if file == "." or file == ".."
      ...
      game_info = File.read("./public/2017-2018/games/#{index}/" + "#{game["gamecode"]}.json")
        sorted_game_info = JSON.parse(game_info)
        sorted_game_info.each do |game|
        stats.gamecode = game["gamecode"]
